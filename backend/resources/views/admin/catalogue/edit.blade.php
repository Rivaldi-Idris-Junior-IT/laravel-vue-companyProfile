@extends('layouts.app', ['title' => 'Edit Catalogue'])
        ...
        <div class="col-md-12">
            <div class="card border-0 shadow">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold"><i class="fas fa-folder"></i> Edit CATALOGUE</h6>
                </div>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.catalogue.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" placeholder="Masukkan Pelayanan Perusahaan" class="form-control @error('name') is-invalid @enderror">
                        ...
                        <div class="form-group">
                            <label>HARGA</label>
                            <input type="number" name="price" value="{{ old('price') }}" placeholder="Masukkan Alamat Perusahaan" class="form-control @error('price') is-invalid @enderror">
