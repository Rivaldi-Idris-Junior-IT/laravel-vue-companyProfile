@extends('layouts.app', ['title' => 'SERVICE (LAYANAN)'])
        ...
        <div class="col-md-12">
            <div class="card border-0 shadow">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold"><i class="fas fa-folder"></i> COMPANY SERVICE</h6>
                </div>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Penjelasan Pelayanan</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ $service->image }}"  style="width:50px"></td>
